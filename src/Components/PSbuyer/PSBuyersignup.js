...
<script src="https://use.fontawesome.com/1dec14be15.js"></script>
    <div class="container-fluid stylish-form" style={{"height":"100%"}}>  
      <h2 class="text-center"> Traders,Buyers and Commodity Exchanges </h2>
      <div class="row mar20" >
            ...
            <form method="POST">
              <div class="mar20 inside-form">
                ...
                {/* <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="company" placeholder="Name..." onChange={handleonchange}/>
                </div> */}
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-envelope "></i></span>
                  <input type="tel" class="form-control" name="email" placeholder="Email..." onChange={handleonchange}/>
                </div>
